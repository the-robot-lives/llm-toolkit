...
Primary entry point after `llm-toolkit serve`. Provides quick access to search, recent conversations, and summary statistics. Designed for rapid orientation — "what was I working on?"
